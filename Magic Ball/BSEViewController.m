...
- (void)viewDidLoad
{
    ...
    NSString *soundPath = [[NSBundle mainBundle]pathForResource:@"magic_ball" ofType:@"mp3"];
    ...
    self.magicBall = [ [BSEMagicBall alloc] init ];
...
-(void) makePrediction{
    ...
    self.predictionLabel.text = [self.magicBall randomPredictions];
